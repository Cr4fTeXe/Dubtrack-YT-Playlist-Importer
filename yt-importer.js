...
if(!$("body").hasClass("import_MP")){
    var onclicktoggle = "$('.import-input').slideToggle()";
...
$(".header-right-navigation").append($('<div class="yt-import" onclick="'+onclicktoggle+'"><img src="https://rawgit.com/sinfulBA/DubX-Script/master/params/params.svg" alt="import"></div>'));
