...
$("body").append($('<div class="import-input"><div class="import-inner"><span class="importer-title">Youtube-Importer by Cr4fTeXe</span><input type="text" id="ytu" name="Playlist-ID" title="Playlist-ID" value="" placeholder="Enter YT Playlist-ID"><input type="text" id="ytpl" name="Dubtrack Playlist-Name" title="Dubtrack Playlist-Name" value="" placeholder="Enter Dubtrack Playlist-Name"><input type="text" id="dtpl" name="Youtube Playlist-Name" title="Youtube Playlist-Name" value="" placeholder="Enter Youtube Playlist-Name"><button class="import_submit" title="Submit Data">Submit</button></div></div>'));
